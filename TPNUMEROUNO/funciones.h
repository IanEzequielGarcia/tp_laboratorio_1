...
/** \brief Muestra los resultados de las operaciones del punto 3, no pongo los nombres porque se hace muy largo
 *
 * \param int
 * \param float
 * \param float
 ...
 *
 */
void MostrarResultados(int,float,float,float,float,long int,long int);
